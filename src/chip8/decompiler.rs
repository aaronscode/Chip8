...
fn decompile_rom(path: String) -> String {
    ...
    match buf.read(&mut rom_bytes) {
        ...
        Ok(n) => {
            for word in rom_bytes.chunks(2) {
                decompile_word(word[0], word[1]);
            }
        }
...
pub fn decompile_word(upper: u8, lower: u8) -> String {
    ...
    decode_instruction(nibble1, nibble2, nibble3, nibble4)
}

fn decode_instruction(n1: u8, n2: u8, n3: u8, n4: u8) -> String {
